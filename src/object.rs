...
pub trait Object: Any {
    ...
    fn borrow(&self) -> &dyn Object;
    fn borrow_mut(&mut self) -> &mut dyn Object;
    fn boxed(self) -> Box<dyn Object>;
    fn as_type(&self) -> Type;
    fn field(&self, name: &str) -> Option<&dyn Object>;
    fn field_mut(&mut self, name: &str) -> Option<&mut dyn Object>;
    fn into_field(self, name: &str) -> Option<Box<dyn Object>>;
    fn method(&self, name: &str) -> Option<Func>;
}

impl<T: Any> Object for T {
    fn any_ref(&self) -> &dyn Any {
        self
    }
    fn any_mut(&mut self) -> &mut dyn Any {
    ...
    default fn field(&self, _: &str) -> Option<&dyn Object> {
        None
    }

    default fn field_mut(&mut self, _: &str) -> Option<&mut dyn Object> {
        None
    }

    default fn into_field(self, _: &str) -> Option<Box<dyn Object>> {
        None
    }
...
impl<K> IndexMut<K> for dyn Object
where
    K: AsRef<str>,
{
